...
public class StatisticheTest {
	...
	public void testRaccoltoPerFormica() {
		...
		Set<Cibo> setCibo = new HashSet<>();
		setCibo.add(this.creaCiboRaccoltoDaEsploratore());
		setCibo.add(this.creaCiboRaccoltoDaInseguitore());
		
		assertTrue(this.stats.raccoltoPerFormica(setCibo).size() != 0);
	}
	...
	public void testRaccoltoPerTipoDiFormica() {
		...
		assertTrue(this.stats.raccoltoPerTipoDiFormica(setCibo).size() != 0);
	}
