...
public class Percorso {
	...
	@Override
	public int hashCode() {
		return this.getOrigine().hashCode()+this.getDestinazione().hashCode()+ this.getBici().hashCode();
	}

	@Override
	public boolean equals(Object o) {
		final Percorso that = (Percorso)o;
		return this.getOrigine().equals(that.getOrigine()) && this.getDestinazione().equals(that.getDestinazione()) && this.getBici().equals(that.getBici());
	}
